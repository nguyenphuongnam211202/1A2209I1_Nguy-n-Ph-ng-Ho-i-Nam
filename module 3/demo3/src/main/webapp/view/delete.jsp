...
<body>
<h1>Xóa sinh viên : ${student.hoTen} </h1>
<form action="/students" method="post">
    <table>
        ...
        <tr><td>Mã sinh viên</td>
            <td><input type="text" name="mssv" value="${student.mssv}"></td>
        </tr>
        <tr><td>Họ tên</td>
            <td><input type="text" name="hoTen" value="${student.hoTen}"></td>
        </tr>
        <tr>
            <td>Giới tính</td>
        ...
        <tr>
            <td></td>
            <td><input type="submit" name="action" value="xac nhan">
